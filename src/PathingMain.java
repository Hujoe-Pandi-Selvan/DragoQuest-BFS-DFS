...
public class PathingMain extends PApplet
{
   ...
   public static enum GridValues { BACKGROUND, OBSTACLE, GOAL, SEARCHED };
   ...
   public static void main(String args[]) {
      PApplet.main(PathingMain.class);
   }
   ...
   public void keyPressed() {
      if (key == '1' || key == 'b') {
         ...
         // EXAMPLE - replace with BFS TODO
  //       Utils.moveOnce(wPos, grid, path);
         Search.BFS(wPos, grid, path);
         ...
         // EXAMPLE - replace with DFS TODO
       //  Utils.moveFive(wPos, grid, path);
        Search.DFS(wPos, grid, path);
